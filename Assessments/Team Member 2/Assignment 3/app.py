...
COS_API_KEY_ID="bBBxmJo1hI3g--0rYjcK8bj54jGJDvxyVdukDJJrQ8J4"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/27b41c5e254d42d8a353c106590a0ab8:9ec1fd6b-ed8b-4a45-9ad7-2d3c9633ed3f::"
...
@app.route('/')
def index():
    files = get_bucket_contents('flasktest')
